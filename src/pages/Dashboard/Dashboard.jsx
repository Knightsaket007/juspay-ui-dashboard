    ...
    <div className='p-5'>
      ...
      <div className='flex lg:flex-row flex-col gap-5 mt-5 h-fit'>
        <div className='flex gap-5  flex-wrap w-full lg:w-1/2 '>
          <div className="p-5 rounded-lg bg-[var(--blue-prime)] w-[45%] lg:w-[46%]">
          ...
          <div className="p-5 rounded-lg bg-[var(--blue-light)] w-[45%] lg:w-[46%] ">
          ...
          <div className="p-5 rounded-lg bg-[var(--purple-light)] w-[45%] lg:w-[46%]">
